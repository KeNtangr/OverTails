...
@export_range(0.0, 5.0, 0.1) var warning_duration: float = 1.0
@export_range(0.05, 2.0, 0.05) var active_duration: float = 0.4
@export_range(1, 1000, 1) var damage: int = 20

var _damaged_body_ids: Dictionary = {}

@onready var warning_line: Polygon2D = $WarningLine
@onready var active_beam: Polygon2D = $ActiveBeam
